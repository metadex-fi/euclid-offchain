...
// TODO revert
// export const maxInteger = 10000000n; // NOTE This will cause weirdness after we added the minAda of 1000000n (utxo.ts)
...
export const webappExpLimit = 11; // our empirically determined expLimit in the webapp TODO outdated
