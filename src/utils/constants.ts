...
export const defaultMaxWeight = 10000n//BigInt(Math.floor(Number(maxInteger) ** 0.25));
...
export const minAdaPerAsset = 5n * lovelacePerAda / 2n; // TODO arbitary aka both excessive and edge-casing
export const feesEtcLovelace = 20n * lovelacePerAda; // costs in lovelace for fees etc. TODO excessive - rn because of opening, suspecting the nft-thing
