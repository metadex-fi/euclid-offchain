...
export class PInteger {
    constructor() {
        ...
        Object.defineProperty(this, "plift", {
            ...
            writable: true,
            value: (i) => {
                assert(typeof i === `bigint`, `.PInteger.plift: expected Integer, got ${i} (${typeof i})`);
                return i;
            }
        });
        Object.defineProperty(this, "pconstant", {
            ...
            writable: true,
            value: (data) => {
                assert(typeof data === `bigint`, `PInteger.pconstant: expected Integer, got ${data} (${typeof data})`);
                return data;
            }
        });
        ...
        Object.defineProperty(this, "showData", {
            ...
            writable: true,
            value: (data) => {
                assert(typeof data === `bigint`, `PInteger.showData: expected Integer, got ${data} (${typeof data})`);
                return `Integer: ${data}`;
            }
        });
