...
import { genByteString, genNonNegative, gMaxStringBytes, maybeNdef, } from "../../../../utils/generators.js";
export class PByteString {
    constructor(minBytes = 0n, maxBytes = gMaxStringBytes) {
        ...
        Object.defineProperty(this, "plift", {
            ...
            writable: true,
            value: (s) => {
                assert(s instanceof Uint8Array, `PByteString.plift: expected Uint8Array, got ${s} (${typeof s})`);
                return s;
            }
        });
        Object.defineProperty(this, "pconstant", {
            ...
            writable: true,
            value: (data) => {
                assert(data instanceof Uint8Array, `PByteString.pconstant: expected Uint8Array, got ${data} (${typeof data})`);
        ...
        Object.defineProperty(this, "showData", {
            ...
            writable: true,
            value: (data) => {
                assert(data instanceof Uint8Array, `PByteString.showData: expected Uint8Array, got ${data} (${typeof data})`);
        ...
        assert(minBytes >= 0n, `PByteString: minBytes must be non-negative, got ${minBytes}`);
        assert(maxBytes >= minBytes, `PByteString: maxBytes must be greater than or equal to minBytes, got ${maxBytes} < ${minBytes}`);
    ...
    static genPType() {
        ...
        const maxBytes = maybeNdef(() => (minBytes ??
