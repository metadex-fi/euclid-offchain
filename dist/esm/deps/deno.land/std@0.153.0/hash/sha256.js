...
var _Sha256_block,
  ...
  _Sha256_hBytes,
  _Sha256_is224,
  _Sha256_lastByteIndex,
  _Sha256_start,
  _HmacSha256_inner,
  _HmacSha256_is224,
  _HmacSha256_oKeyPad,
  _HmacSha256_sharedMemory;
...
export class Sha256 {
  ...
  init(is224, sharedMemory) {
    if (sharedMemory) {
      ...
      __classPrivateFieldSet(this, _Sha256_blocks, [
        0,
        0,
        0,
        0,
    ...
    __classPrivateFieldSet(
      ...
      __classPrivateFieldSet(
        ...
        __classPrivateFieldSet(
          this,
          _Sha256_bytes,
          __classPrivateFieldSet(this, _Sha256_hBytes, 0, "f"),
          "f",
        ),
        "f",
      ),
  ...
  update(message) {
    ...
    while (index < length) {
      ...
      if (typeof msg !== "string") {
        for (
          i = __classPrivateFieldGet(this, _Sha256_start, "f");
          index < length && i < 64;
          ++index
        ) {
      ...
      __classPrivateFieldSet(
        this,
        _Sha256_bytes,
        __classPrivateFieldGet(this, _Sha256_bytes, "f") +
          (i - __classPrivateFieldGet(this, _Sha256_start, "f")),
        "f",
      );
      if (i >= 64) {
    ...
    if (__classPrivateFieldGet(this, _Sha256_bytes, "f") > 4294967295) {
      __classPrivateFieldSet(
        this,
        _Sha256_hBytes,
        __classPrivateFieldGet(this, _Sha256_hBytes, "f") +
          ((__classPrivateFieldGet(this, _Sha256_bytes, "f") / 4294967296) <<
            0),
        "f",
      );
      __classPrivateFieldSet(
  ...
  finalize() {
    ...
    blocks[14] = (__classPrivateFieldGet(this, _Sha256_hBytes, "f") << 3) |
      (__classPrivateFieldGet(this, _Sha256_bytes, "f") >>> 29);
  ...
  hash() {
    ...
    __classPrivateFieldSet(
      this,
      _Sha256_h0,
      (__classPrivateFieldGet(this, _Sha256_h0, "f") + a) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h1,
      (__classPrivateFieldGet(this, _Sha256_h1, "f") + b) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h2,
      (__classPrivateFieldGet(this, _Sha256_h2, "f") + c) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h3,
      (__classPrivateFieldGet(this, _Sha256_h3, "f") + d) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h4,
      (__classPrivateFieldGet(this, _Sha256_h4, "f") + e) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h5,
      (__classPrivateFieldGet(this, _Sha256_h5, "f") + f) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h6,
      (__classPrivateFieldGet(this, _Sha256_h6, "f") + g) << 0,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Sha256_h7,
      (__classPrivateFieldGet(this, _Sha256_h7, "f") + h) << 0,
      "f",
    );
  }
  ...
  arrayBuffer() {
    ...
    const buffer = new ArrayBuffer(
      __classPrivateFieldGet(this, _Sha256_is224, "f") ? 28 : 32,
    );
...
_Sha256_block = new WeakMap(),
  _Sha256_blocks = new WeakMap(),
  _Sha256_bytes = new WeakMap(),
  _Sha256_finalized = new WeakMap(),
  _Sha256_first = new WeakMap(),
  _Sha256_h0 = new WeakMap(),
  _Sha256_h1 = new WeakMap(),
  _Sha256_h2 = new WeakMap(),
  _Sha256_h3 = new WeakMap(),
  _Sha256_h4 = new WeakMap(),
  _Sha256_h5 = new WeakMap(),
  _Sha256_h6 = new WeakMap(),
  _Sha256_h7 = new WeakMap(),
  _Sha256_hashed = new WeakMap(),
  _Sha256_hBytes = new WeakMap(),
  _Sha256_is224 = new WeakMap(),
  _Sha256_lastByteIndex = new WeakMap(),
  _Sha256_start = new WeakMap();
export class HmacSha256 extends Sha256 {
  ...
  finalize() {
    ...
    if (__classPrivateFieldGet(this, _HmacSha256_inner, "f")) {
      ...
      super.init(
        __classPrivateFieldGet(this, _HmacSha256_is224, "f"),
        __classPrivateFieldGet(this, _HmacSha256_sharedMemory, "f"),
      );
...
_HmacSha256_inner = new WeakMap(),
  _HmacSha256_is224 = new WeakMap(),
  _HmacSha256_oKeyPad = new WeakMap(),
  _HmacSha256_sharedMemory = new WeakMap();
