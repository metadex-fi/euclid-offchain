  ...
  soldSpot: ${this.soldSpot}
    ...
    Object.defineProperty(this, "tx", {
      ...
      value: (tx) => {
        ...
        const swapRedeemer = PEuclidAction.ptype.pconstant(
          new SwapRedeemer(
            new Swap(
              this.boughtAsset,
              this.soldAsset,
              new BoughtSold(this.boughtSpot, this.soldSpot),
            ),
          ),
        );
        ...
        console.log(
          PositiveValue.fromLucid(this.diracUtxo.utxo.assets).concise(),
        );
    ...
    Object.defineProperty(this, "subSwap", {
      ...
      value: (amount, amountIsSold) => {
        const offerA0 = (amountIsSold ? this.boughtAmount : amount) *
          this.soldSpot;
