  ...
  effectivePrice: ${this.effectivePrice}
        ...
        Object.defineProperty(this, "subSwap", {
            ...
            value: (amount, amntIsSold) => {
                ...
                return new Swapping(this.user, this.paramUtxo, this.diracUtxo, this.boughtAsset, this.soldAsset, boughtAmount, soldAmount, this.boughtSpot, this.soldSpot, this.boughtExp, this.soldExp);
            }
        });
    ...
    static boundary(user, paramUtxo, diracUtxo, boughtAsset, soldAsset, boughtAmount, soldAmount, boughtSpot, soldSpot, boughtExp, soldExp) {
        return new Swapping(user, paramUtxo, diracUtxo, boughtAsset, soldAsset, boughtAmount, soldAmount, boughtSpot, soldSpot, boughtExp, soldExp);
    }
