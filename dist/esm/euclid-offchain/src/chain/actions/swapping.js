  ...
  effectivePrice: ${this.effectivePrice}
        ...
        const swapRedeemer = PEuclidAction.ptype.pconstant(
          new SwapRedeemer(
            new Swap(
              this.boughtAsset,
              this.soldAsset,
              new BoughtSold(this.boughtExp, this.soldExp),
            ),
          ),
        );
    ...
    Object.defineProperty(this, "subSwap", {
      ...
      value: (amount, amntIsSold) => {
        const offerA0 = (amntIsSold ? this.boughtAmount : amount) *
          this.soldSpot;
        const demandA0 = (amntIsSold ? amount : this.soldAmount) *
          this.boughtSpot;
        ...
        const soldAmount = BigInt(
          Math.ceil(Number(boughtAmount) * this.spotPrice),
        );
        assert(
          soldAmount <= this.soldAmount,
