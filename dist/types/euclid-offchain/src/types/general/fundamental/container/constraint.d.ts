...
export declare class PConstraint<PInner extends PData> implements PType<PConstanted<PInner>, PLifted<PInner>> {
    pinner: PInner;
    asserts: ((i: PLifted<PInner>) => void)[];
    genInnerData: () => PLifted<PInner>;
    details?: string | undefined;
    population: number;
    constructor(pinner: PInner, asserts: ((i: PLifted<PInner>) => void)[], genInnerData: () => PLifted<PInner>, details?: string | undefined);
