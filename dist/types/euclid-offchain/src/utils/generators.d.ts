...
export declare const maxInteger: bigint;
...
export declare class Generators {
    ...
    constructor(primitives: Array<() => PData>, containers: Array<(gen: Generators, maxDepth: bigint) => PData>);
...
export declare function boundedSubset<T>(set: T[], minSize?: bigint, maxSize?: bigint): T[];
...
export declare function genByteString(minBytes?: bigint, maxBytes?: bigint): Uint8Array;
