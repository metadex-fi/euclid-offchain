...
export function instantiate(opts?: InstantiateOptions | undefined): Promise<{
  ...
  encode_arbitrary_bytes_as_metadatum:
    typeof encode_arbitrary_bytes_as_metadatum;
  decode_arbitrary_bytes_from_metadatum:
    typeof decode_arbitrary_bytes_from_metadatum;
...
export function instantiateWithInstance(
  opts?: InstantiateOptions | undefined,
): Promise<{
  instance: WebAssembly.Instance;
  exports: {
    encrypt_with_password: typeof encrypt_with_password;
...
export class TransactionBuilder {
  ...
  add_input(
    ...
    script_witness: ScriptWitness | undefined,
  ): void;
  /**
   * @param {TransactionUnspentOutput} utxo
   */
   ...
   */
  construct(
    collateral_utxos: TransactionUnspentOutputs | undefined,
    collateral_change_address: Address | undefined,
    native_uplc: boolean | undefined,
  ): Promise<Transaction>;
  /**
   * Returns full Transaction object with the body and the auxiliary data
   * NOTE: witness_set will contain all mint_scripts if any been added or set
