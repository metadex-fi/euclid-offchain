...
export declare const Data: {
  ...
  Array: <T extends TSchema>(items: T, options?: {
    ...
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TArray<
      T
    >;
  Map: <T_1 extends TSchema, U extends TSchema>(
    keys: T_1,
    values: U,
    options?: {
      minItems?: number;
    ...
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TUnsafe<
      Map<Data.Static<T_1, []>, Data.Static<U, []>>
    >;
  /**
  ...
  Object: <T_2 extends TProperties>(properties: T_2, options?: {
    ...
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TObject<
      T_2
    >;
  Enum: <T_3 extends TSchema>(
    items: T_3[],
  ) =>
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TUnion<
      T_3[]
    >;
  /**
  ...
  Tuple: <T_4 extends TSchema[]>(items: [...T_4], options?: {
    ...
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TTuple<
      T_4
    >;
  Literal: <T_5 extends TLiteralValue>(title: T_5) => TLiteral<T_5>;
  Nullable: <T_6 extends TSchema>(
    item: T_6,
  ) =>
    import("../../../deps/deno.land/x/typebox@0.25.13/src/typebox.js").TUnsafe<
      Data.Static<T_6, []> | null
    >;
  /**
