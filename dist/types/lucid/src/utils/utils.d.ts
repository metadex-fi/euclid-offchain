...
export declare function stakeCredentialOf(
...
export declare function coreToUtxo_(
  txHash: string,
  index: number,
 ...
 */
export declare function toUnit(
  policyId: PolicyId,
  name?: string | null,
  label?: number | null,
): Unit;
 ...
 * It follows this Json format: https://github.com/input-output-hk/cardano-node/blob/master/doc/reference/simple-scripts.md
 */
export declare function nativeScriptFromJson(
  nativeScript: NativeScript,
): Script;
export declare function applyParamsToScript<T extends unknown[] = Data[]>(
  plutusScript: string,
  params: [...T],
  shape?: TSchema,
): string;
