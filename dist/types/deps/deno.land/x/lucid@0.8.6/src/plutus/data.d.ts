import { Static as _Static, TLiteral, TLiteralValue, TObject, TProperties, TSchema } from "../../../typebox@0.25.13/src/typebox.js";
...
export declare const Data: {
    BigInt: import("../../../typebox@0.25.13/src/typebox.js").TUnsafe<bigint>;
    String: import("../../../typebox@0.25.13/src/typebox.js").TString<string>;
    Boolean: import("../../../typebox@0.25.13/src/typebox.js").TBoolean;
    Any: import("../../../typebox@0.25.13/src/typebox.js").TAny;
    Array: <T extends TSchema>(schema: T) => import("../../../typebox@0.25.13/src/typebox.js").TArray<T>;
    Map: <T_1 extends TSchema, U extends TSchema>(keySchema: T_1, valueSchema: U) => import("../../../typebox@0.25.13/src/typebox.js").TUnsafe<Map<Data.Static<T_1, []>, Data.Static<U, []>>>;
    Object: <T_2 extends TProperties>(properties: T_2) => TObject<T_2>;
    Enum: <T_3 extends TSchema>(items: T_3[]) => import("../../../typebox@0.25.13/src/typebox.js").TUnion<T_3[]>;
    Tuple: <T_4 extends TSchema[]>(items: [...T_4]) => import("../../../typebox@0.25.13/src/typebox.js").TTuple<T_4>;
    Literal: <T_5 extends TLiteralValue>(literal: T_5) => TLiteral<T_5>;
    Nullable: <T_6 extends TSchema>(schema: T_6) => import("../../../typebox@0.25.13/src/typebox.js").TUnsafe<Data.Static<T_6, []> | null>;
    /**
