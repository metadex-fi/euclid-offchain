...
export declare type TConstructorParameters<
  T extends TConstructor<TSchema[], TSchema>,
> = TTuple<T["parameters"]>;
export declare type TInstanceType<T extends TConstructor<TSchema[], TSchema>> =
  T["returns"];
export declare type StaticContructorParameters<
...
export declare type StaticFunctionParameters<
  T extends readonly TSchema[],
  P extends unknown[],
> = [
  ...{
...
export declare type IntersectReduce<
  I extends unknown,
  T extends readonly any[],
> = T extends [infer A, ...infer B] ? IntersectReduce<I & A, B>
  : I extends object ? I
  : {};
export declare type IntersectEvaluate<
  T extends readonly TSchema[],
  P extends unknown[],
> = {
  [K in keyof T]: T[K] extends TSchema ? Static<T[K], P> : never;
...
export declare type UnionToIntersect<U> =
...
export declare type UnionLast<U> =
  UnionToIntersect<U extends unknown ? (x: U) => 0 : never> extends
    (x: infer L) => 0 ? L : never;
export declare type UnionToTuple<U, L = UnionLast<U>> = [U] extends [never] ? []
...
export declare type RequiredPropertyKeys<T extends TProperties> = keyof Omit<
  T,
  | ReadonlyOptionalPropertyKeys<T>
  | ReadonlyPropertyKeys<T>
  | OptionalPropertyKeys<T>
>;
export declare type PropertiesReduce<
...
> =
  ...
  : never;
export declare type TRecordProperties<
...
export declare type ObjectProperties<T> = T extends TObject<infer U> ? U
  : never;
export declare type ObjectPropertyKeys<T> = T extends TObject<infer U> ? keyof U
  : never;
...
export declare type TRecursiveReduce<T extends TSchema> = Static<
  T,
  [TRecursiveReduce<T>]
>;
...
export declare type TupleToArray<T extends TTuple<TSchema[]>> = T extends
...
export declare class TypeBuilder {
  ...
  Literal<T extends TLiteralValue>(
    value: T,
    options?: SchemaOptions,
  ): TLiteral<T>;
  ...
  Parameters<T extends TFunction<any[], any>>(
    schema: T,
    options?: SchemaOptions,
  ): TParameters<T>;
  ...
  ReturnType<T extends TFunction<any[], any>>(
    schema: T,
    options?: SchemaOptions,
  ): TReturnType<T>;
